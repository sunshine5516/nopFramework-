...
namespace NopFramework.Services.Seo
{
    ...
    public partial class UrlRecordService : IUrlRecordService
    {
        ...
        private const string URLRECORD_PATTERN_KEY = "Sun.urlrecord";
        /// <summary>
        /// Key for caching
        /// </summary>
        ...
        public virtual UrlRecord GetBySlug(string slug)
        {
            ...
            return urlRecord;
            //var q = _urlRecordRepository.Table.Where(ur => ur.Slug == slug).OrderBy(ur => ur.Slug).OrderByDescending(ur => ur.Id).FirstOrDefault();
        }
        /// <summary>
        /// 获取所有URL记录
        /// </summary>
        ...
        public virtual string GetActiveSlug(int entityId, string entityName, int languageId)
        {
            ...
            //     {
            //         //加载所有记录 (we know they are cached)
